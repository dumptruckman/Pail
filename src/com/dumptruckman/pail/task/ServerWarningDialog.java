...
import static com.dumptruckman.pail.tools.TimeTools.secondsFromHms;
...
public class ServerWarningDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        //org.jdesktop.application.ResourceMap lang = org.jdesktop.application.Application.getInstance(com.dumptruckman.pail.pail.Main.class).getContext().getResourceMap(ServerWarningDialog.class);
        ...
        timeBeforeField.setInputVerifier(new com.dumptruckman.pail.tools.RegexVerifier("^(\\d{1,2}h)?\\s?(\\d{1,2}m)?\\s?(\\d{1,2}s)?$"));
