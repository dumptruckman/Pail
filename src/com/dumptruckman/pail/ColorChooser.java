...
public class ColorChooser extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        //org.jdesktop.application.ResourceMap lang = org.jdesktop.application.Application.getInstance(com.dumptruckman.pail.pail.Main.class).getContext().getResourceMap(ColorChooser.class);
        ResourceBundle lang = ResourceBundle.getBundle("ColorChooser");
        colorChooser.setColor(new Color(204, 153, 0));
        colorChooser.setName("colorChooser");

        jButton1.setText(lang.getString("jButton1.text")); // NOI18N
        ...
        jButton2.setText(lang.getString("jButton2.text")); // NOI18N
