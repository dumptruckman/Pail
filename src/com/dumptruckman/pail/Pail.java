package com.dumptruckman.pail;

import com.dumptruckman.pail.backup.Backup;
import com.dumptruckman.pail.config.Config;
import com.dumptruckman.pail.config.ServerProperties;
import com.dumptruckman.pail.mcserver.MCServerModel;
import com.dumptruckman.pail.proxyserver.PlayerList;
import com.dumptruckman.pail.task.TaskDialog;
import com.dumptruckman.pail.task.event.EventModel;
import com.dumptruckman.pail.tools.ConsoleParser;
import com.dumptruckman.pail.tools.RegexVerifier;
import com.dumptruckman.pail.webinterface.WebInterface;
...
import static com.dumptruckman.pail.task.event.EventScheduler.scheduleImmediateEvent;
import static com.dumptruckman.pail.tools.TimeTools.getTimeStamp;
    ...
    */
    ...
    private void initComponents() {
        ...
        mainPanel.add(tabber, "grow");
        {
            ...
            tabber.addTab(lang.getString("mainWindowTab.TabConstraints.tabTitle"), mainWindowTab);
            {
                    ...
                    consoleOutputPanel.add(consoleOutScrollPane, "grow");
                    {
                        ...
                        consoleOutput.addMouseListener(new MouseAdapter() {
                            public void mouseClicked(MouseEvent evt) {
                                consoleOutputMouseClicked();
                            }
                            public void mouseEntered(MouseEvent evt) {
                                consoleOutputMouseEntered();
                            }
                ...
                mainWindowTab.add(consoleInputPanel, "grow, span 3, wrap");
                {
                    ...
                    submitButton.setText(lang.getString("submitButton.text"));
                ...
                //configurationTab.add(configTabber, "grow");
                {
                    ...
                    //configTabber.addTab("GUI Settings", guiConfigPanel);
                    {
                        ...
                        useProxyCheckBox.addActionListener(new ActionListener() {
                            public void actionPerformed(ActionEvent evt) {
                                useProxyCheckBoxActionPerformed();
                            }
                        });
                        ...
                        commandPrefixField.addActionListener(new ActionListener() {
                            public void actionPerformed(ActionEvent evt) {
                                commandPrefixFieldActionPerformed();
                            }
                        });
            ...
            tabber.addTab(lang.getString("backupTab.TabConstraints.tabTitle"), backupTab);
            {
                ...
                backupTab.add(backupFileChooserPanel, "grow, wrap");
                {
                    ...
                    backupFileList.setModel(config.backups.getPathsModel());
            ...
            tabber.addTab(lang.getString("schedulerTab.TabConstraints.tabTitle"), schedulerTab);
            {
                ...
                pauseSchedulerButton.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent evt) {
                        pauseSchedulerButtonActionPerformed();
                    }
                });
            ...
            tabber.addTab(lang.getString("webInterfaceTab.TabConstraints.tabTitle"), webInterfaceTab);
            {
                ...
                webInterfaceTab.add(webInterfaceConfigPanel, "grow, wrap");
                {
                    ...
                    showWebPasswordButton.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent evt) {
                            showWebPasswordButtonActionPerformed();
                        }
                    });
                    ...
                    disableGetOutputNotificationsCheckBox.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent evt) {
                            disableGetOutputNotificationsCheckBoxActionPerformed();
                        }
                    });
            ...
            tabber.addTab(lang.getString("themeTab.TabConstraints.tabTitle"), themeTab);
            {
                ...
                themeTab.add(colorizationPanel, "grow, wrap");
                {
                    ...
                    severeColorBox.setToolTipText(lang.getString("severeColorBox.toolTipText"));
                    severeColorBox.setName("severeColorBox");
                ...
                saveThemeButton.setText(lang.getString("saveThemeButton.text"));
                saveThemeButton.setMargin(new Insets(2, 5, 2, 5));
                saveThemeButton.setName("saveThemeButton");
        ...
        hideMenu.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
                hideMenuMouseClicked();
            }
        });
        menuBar.add(hideMenu);

        versionNotifier.setText(lang.getString("versionNotifier.text"));
        versionNotifier.setToolTipText(lang.getString("versionNotifier.toolTipText"));
        versionNotifier.setName("versionNotifier");

        launchSupportPage.setText(lang.getString("launchSupportPage.text"));
        launchSupportPage.setName("launchSupportPage");
        launchSupportPage.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                launchSupportPageActionPerformed();
            }
        });
        versionNotifier.add(launchSupportPage);

        viewChangeLog.setText(lang.getString("viewChangeLog.text"));
        viewChangeLog.setName("viewChangeLog");
        viewChangeLog.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                viewChangeLogActionPerformed();
            }
        });
        versionNotifier.add(viewChangeLog);

        downloadLatestVersion.setText(lang.getString("downloadLatestVersion.text"));
        downloadLatestVersion.setName("downloadLatestVersion");
        downloadLatestVersion.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                downloadLatestVersionActionPerformed();
            }
        });
        versionNotifier.add(downloadLatestVersion);

        jMenuItem1.setText(lang.getString("jMenuItem1.text"));
        ...
        serverStatusLabel.setText(lang.getString("serverStatusLabel.text"));
        serverStatusLabel.setName("serverStatusLabel");
        ...
        statusBarJob.setText(lang.getString("statusBarJob.text"));
        statusBarJob.setName("statusBarJob");
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                if (returnVal == JFileChooser.APPROVE_OPTION) {
                    ...
                    for (File file : files) {
                        //if (!backupFileListModel.contains(file))
                        //    backupFileListModel.add(file);
                        if (!config.backups.getPathsModel().contains(file))
                            config.backups.getPathsModel().add(file);
                    }
                }
                cmdLineField.setText(config.cmdLine.parseCmdLine());
            }
    ...
    private void backupRemoveButtonActionPerformed(java.awt.event.ActionEvent ignore) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                if (backupFileList.getSelectedIndex() == -1) return;
                Object[] objects = backupFileList.getSelectedValues();
                if (objects != null) {
                    removeFilesFromPaths(objects);
                }
            }
        });
    }

    public void removeFilesFromPaths(Object[] objects) {
        for (Object obj : objects) {
            config.backups.getPathsModel().removeElement((File)obj);
        }
    }

    private void taskListEditButtonActionPerformed(java.awt.event.ActionEvent evt) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
    ...
    private void taskListRemoveButtonActionPerformed(java.awt.event.ActionEvent evt) {
        removeTaskListEntry();
    }
    ...
    private void showWebPasswordButtonActionPerformed() {
        SwingUtilities.invokeLater(new Runnable() {
             public void run() {
    ...
    private void webPasswordFieldFocusLost() {
        SwingUtilities.invokeLater(new Runnable() {
             public void run() {
                config.web.setPassword(String.valueOf(webPasswordField.getPassword()));
            }
    ...
    private void disableGetOutputNotificationsCheckBoxActionPerformed() {
        SwingUtilities.invokeLater(new Runnable() {
             public void run() {
    ...
    private void consoleOutputMouseClicked() {
        SwingUtilities.invokeLater(new Runnable() {
             public void run() {
                if (server.isRunning()) {
                    textScrolling = false;
    ...
    private void customButton1ActionPerformed() {
        customButtonAction(customCombo1);
    }

    private void customButton2ActionPerformed() {
        customButtonAction(customCombo2);
    }

    private void useProxyCheckBoxActionPerformed() {
        SwingUtilities.invokeLater(new Runnable() {
             public void run() {
    ...
    private void hideMenuMouseClicked() {
        SwingUtilities.invokeLater(new Runnable() {
             public void run() {
    ...
    private void textSizeFieldStateChanged() {
        SwingUtilities.invokeLater(new Runnable() {
             public void run() {
                config.display.setTextSize(Integer.parseInt(textSizeField.getValue().toString()));
            }
    ...
    private void commandPrefixFieldActionPerformed() {
        SwingUtilities.invokeLater(new Runnable() {
             public void run() {
    ...
    private void launchSupportPageActionPerformed() {
        String url = "http://forums.bukkit.org/threads/17834/";
        try {
    ...
    private void viewChangeLogActionPerformed() {
        SwingUtilities.invokeLater(new Runnable() {
             public void run() {
    ...
    private void downloadLatestVersionActionPerformed() {
        String urltext = "https://raw.github.com/dumptruckman/Pail/master/VERSION";
        String newVersion= "";
        try {
            ...
            in.close();
            String downloadurl = "https://github.com/downloads/dumptruckman/Pail/pail-" + newVersion + ".zip";
            try {
    ...
    private void pauseSchedulerButtonActionPerformed() {
        pauseSchedule();
    }
    ...
    private void taskSchedulerListKeyTyped(java.awt.event.KeyEvent evt) {
        final java.awt.event.KeyEvent event = evt;
        SwingUtilities.invokeLater(new Runnable() {
             public void run() {
    ...
    private void consoleOutputMouseEntered() {
        SwingUtilities.invokeLater(new Runnable() {
             public void run() {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                if (serverState.equals("ON")) {
                    ...
                    backupAddButton.setEnabled(false);
                    backupRemoveButton.setEnabled(false);
                    ...
                    backupAddButton.setEnabled(true);
                    backupRemoveButton.setEnabled(true);
