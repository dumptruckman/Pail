...
package com.dumptruckman.pail.tools;
...
public class ConsoleParser {
    ...
    public ConsoleParser(Config.Display display, Pail pail) {
    ...
    public String parseText(String text) {
        ...
        if (text.contains("[") && text.contains("]"))  {
            ...
            if (tag.equals("INFO")) {
                ...
                */
                ...
                if (pail.config.getProxy() &&
                    ...
                    pail.guiLog("Are the Proxy Port and Server Port the same?  "
            ...
            } else if (tag.equals("MC Server Pail")) {
                tag = "[" + tag + "]";
            } else {
                tag = "[" + tag + "]";
            }
