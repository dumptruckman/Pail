...
package org.dumptruckman.pail.config;
...
public class Config {
    ...
    public class Backups {
        public Backups() {
            ...
            _clearLog = false;
            try {
                _path = new File(".").getCanonicalPath() + System.getProperty("file.separator") + "org.dumptruckman.pail.pail-backups";
            } catch (IOException e) {
                _path = "";
