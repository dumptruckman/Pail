...
public class TaskDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        //org.jdesktop.application.ResourceMap lang = org.jdesktop.application.Application.getInstance(org.dumptruckman.pail.pail.Main.class).getContext().getResourceMap(TaskDialog.class);
        ResourceBundle lang = ResourceBundle.getBundle("TaskDialog");
        taskNameLabel.setText(lang.getString("taskNameLabel.text")); // NOI18N
        taskNameLabel.setName("taskNameLabel"); // NOI18N

        taskNameField.setText(lang.getString("taskNameField.text")); // NOI18N
        taskNameField.setToolTipText(lang.getString("taskNameField.toolTipText")); // NOI18N
        taskNameField.setName("taskNameField"); // NOI18N

        jSeparator1.setOrientation(javax.swing.SwingConstants.VERTICAL);
        jSeparator1.setName("jSeparator1"); // NOI18N

        secondsLabel.setText(lang.getString("secondsLabel.text")); // NOI18N
        secondsLabel.setName("secondsLabel"); // NOI18N

        secondsField.setText(lang.getString("secondsField.text")); // NOI18N
        secondsField.setToolTipText(lang.getString("secondsField.toolTipText")); // NOI18N
        secondsField.setInputVerifier(new org.dumptruckman.pail.tools.RegexVerifier("^([0-5]?\\d(,\\s?[0-5]?\\d){0,59}|[0-5]?\\d-[0-5]?\\d)$"));
        ...
        secondsAgainField.setInputVerifier(new org.dumptruckman.pail.tools.RegexVerifier("^[0-5]?\\d$"));
        ...
        minutesAgainField.setInputVerifier(new org.dumptruckman.pail.tools.RegexVerifier("^[0-5]?\\d$"));
        ...
        minutesField.setInputVerifier(new org.dumptruckman.pail.tools.RegexVerifier("^([0-5]?\\d(,\\s?[0-5]?\\d){0,59}|[0-5]?\\d-[0-5]?\\d)$"));
        ...
        hoursField.setInputVerifier(new org.dumptruckman.pail.tools.RegexVerifier("^([0-2]?\\d(,\\s?[0-2]?\\d){0,23}|[0-2]?\\d-[0-2]?\\d)$"));
        ...
        hoursAgainField.setInputVerifier(new org.dumptruckman.pail.tools.RegexVerifier("^[0-2]?\\d$"));
        ...
        dowAllButton.setText(lang.getString("dowAllButton.text")); // NOI18N
        dowAllButton.setToolTipText(lang.getString("dowAllButton.toolTipText")); // NOI18N
        ...
        monthLabel.setText(lang.getString("monthLabel.text")); // NOI18N
        monthLabel.setName("monthLabel"); // NOI18N

        domButton.setFont(boldFont); // NOI18N
        domButton.setSelected(true);
        domButton.setText(lang.getString("domButton.text")); // NOI18N
        domButton.setToolTipText(lang.getString("domButton.toolTipText")); // NOI18N
        ...
        domField.setInputVerifier(new org.dumptruckman.pail.tools.RegexVerifier("^([0-3]?\\d(,\\s?[0-3]?\\d){0,30}|[0-3]?\\d-[0-3]?\\d)$"));
        domField.setName("domField"); // NOI18N

        domAllCheckBox.setSelected(true);
        domAllCheckBox.setText(lang.getString("domAllCheckBox.text")); // NOI18N
        domAllCheckBox.setToolTipText(lang.getString("domAllCheckBox.toolTipText")); // NOI18N
        ...
        sunButton.setBackground(Color.WHITE); // NOI18N
        sunButton.setText(lang.getString("sunButton.text")); // NOI18N
        ...
        monButton.setBackground(Color.WHITE); // NOI18N
        monButton.setText(lang.getString("monButton.text")); // NOI18N
        ...
        tueButton.setBackground(Color.WHITE); // NOI18N
        tueButton.setText(lang.getString("tueButton.text")); // NOI18N
        ...
        wedButton.setBackground(Color.WHITE); // NOI18N
        wedButton.setText(lang.getString("wedButton.text")); // NOI18N
        ...
        thuButton.setBackground(Color.WHITE); // NOI18N
        thuButton.setText(lang.getString("thuButton.text")); // NOI18N
        ...
        friButton.setBackground(Color.WHITE); // NOI18N
        friButton.setText(lang.getString("friButton.text")); // NOI18N
        ...
        satButton.setBackground(Color.WHITE); // NOI18N
        satButton.setText(lang.getString("satButton.text")); // NOI18N
        ...
        remainDownField.setInputVerifier(new org.dumptruckman.pail.tools.RegexVerifier("^(\\d{1,2}\\s?h)?\\s?(\\d{1,2}\\s?m)?\\s?(\\d{1,2}\\s?s)?$"));
        ...
        serverWarningLabel.setText(lang.getString("serverWarningLabel.text")); // NOI18N
        ...
        warningList.setToolTipText(lang.getString("warningList.toolTipText")); // NOI18N
    ...
    private void warningAddButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_warningAddButtonActionPerformed
        SwingUtilities.invokeLater(new Runnable() {
            @Override public void run() {
                ...
                //@TODO Main.getApplication().show(warningDialog);
            }
        });
